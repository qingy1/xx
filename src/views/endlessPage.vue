    ...
    <div class="endless-tower">
        <div class="battle-info">
            <div class="player-info">
                ...
                <el-progress :percentage="playerProgress" :status="playerStatus" :format="playerHealth"
            ...
            <div class="monster-info" v-if="monster">
                ...
                <el-progress :percentage="monsterProgress" :status="monsterStatus" :format="monsterhealth"
                    :stroke-width="20" text-inside />
            </div>
        </div>
        <div class="actions">
