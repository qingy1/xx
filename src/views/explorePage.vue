...
export default {
    ...
    mounted() {
        ...
        console.log(this.$store.monster)
    ...
    methods: {
        ...
        triggerRandomEvent() {
            ...
            this.currentEvent = this.$store.randomEvent;
        },
        ...
        handleEventOption(option) {
            switch (option.outcome) {
                case 'positive':
                    ...
                    break;
                case 'negative':
                    this.handleNegativeOutcome();
                    break;
                case 'neutral':
                    this.handleNeutralOutcome();
                    break;
                case 'random':
                    Math.random() < 0.5 ? this.handlePositiveOutcome() : this.handleNegativeOutcome();
                    break;
            }
        ...
        fightMonster() {
            ...
            if (this.guashaRounds > 1) {
                ...
                if (this.monster.health <= 0) {
                    ...
                    // 发送提示
                    this.texts = [...this.texts, `击败${this.monster.name}后你获得了${reincarnation}颗培养丹，击杀数量${this.player.jishaNum} `];
