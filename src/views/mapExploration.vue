    ...
    <div>
        ...
        <div class="map">
            <div class="grid-container">
                <div v-for="(cell, index) in grid" :key="index" :ref="'cell-' + index"
                    :class="['grid-item', cell.type, `x-${index % this.gridSize}`, `y-${Math.floor(index / this.gridSize)}`]"
                    :style="{ backgroundColor: cell.his }" @click="gridInfo(index, cell)"></div>
            </div>
        </div>
        <div class="controls">
            ...
            <el-button class="right-button" @click="move('right')"
        ...
        <el-drawer v-model="fishingShow" @close="endGame" title="钓鱼" direction="rtl" class="strengthen">
            <div class="game-container">
                ...
                <el-button @touchstart="startFishing" @touchend="stopFishing" @mousedown="startFishing"
                    @mouseup="stopFishing" @mouseleave="stopFishing" @click="moveButton('click')"
                    :disabled="fishing.disabled" class="button">
